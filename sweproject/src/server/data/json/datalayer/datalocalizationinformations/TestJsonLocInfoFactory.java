...
public class TestJsonLocInfoFactory implements IJsonLocInfoFactory {

    private static final String ACTIVITY_PATH = "test/JFTest/activities.json";
    private static final String ACTIVITY_MEMBER_NAME = "activities";
    private static final String ACTIVITY_KEY_DESC = "title";
    private static final String PLACES_PATH = "test/JFTest/places.json";
    ...
    private static final String GENERAL_CONFIG_PATH = "test/JFTest/configs.json";
    private static final String VOLUNTEER_PATH = "test/JFTest/volunteers.json";
    ...
    private static final String MONTHLY_CONFIG_PATH = "test/JFTest/monthlyConfigs.json";
    private static final String MONTHLY_PLAN_PATH = "test/JFTest/monthlyPlan.json";
    ...
    private static final String USERS_PATH = "test/JFTest/users.json";
    private static final String ARCHIVE_PATH = "test/JFTest/archive.json";
    private static final String ARCHIVE_MEMBER_NAME = "activityArchive";
    private static final String SUBSCRIPTION_PATH = "test/JFTest/subscription.json";
    private static final String SUBSCRIPTION_MEMBER_NAME = "activitySubscription";
    private static final String CHANGED_ACTIVITY_PATH = "test/JFTest/changedActivities.json";
    private static final String CHANGED_PLACES_PATH = "test/JFTest/changedPlaces.json";
