...
public class NormalFunctionJsonLocInfoFactory implements ILocInfoFactory<JsonDataLocalizationInformation> {

    private static final String ACTIVITY_PATH = "sweproject/JFNormalFunction/activities.json";
    private static final String ACTIVITY_MEMBER_NAME = "activities";
    private static final String ACTIVITY_KEY_DESC = "title";
    private static final String PLACES_PATH = "sweproject/JFNormalFunction/places.json";
    ...
    private static final String GENERAL_CONFIG_PATH = "sweproject/JFNormalFunction/configs.json";
    private static final String VOLUNTEER_PATH = "sweproject/JFNormalFunction/volunteers.json";
    ...
    private static final String MONTHLY_CONFIG_PATH = "sweproject/JFNormalFunction/monthlyConfigs.json";
    private static final String MONTHLY_PLAN_PATH = "sweproject/JFNormalFunction/monthlyPlan.json";
    ...
    private static final String USERS_PATH = "sweproject/JFNormalFunction/users.json";
    private static final String ARCHIVE_PATH = "sweproject/JFNormalFunction/archive.json";
